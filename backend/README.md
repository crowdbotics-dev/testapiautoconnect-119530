...
## Project Structure
    ...
    ├── testapiautoconnect_119530  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_119530`
...
2. Clone this repo and `cd testapiautoconnect_119530`
